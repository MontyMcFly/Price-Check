...
-- Allow reading other users' usernames (e.g. for shared features in the future)
...
-- ============================================================
-- STEP 5: Create the "Puguita" user (run this LAST)
-- ============================================================
-- Uncomment and run this separately after the above:
-- SELECT auth.create_user(
--   '{"email": "puguita@pricecheck.app", "password": "123456", "email_confirm": true, "user_metadata": {"username": "Puguita"}}'::jsonb
-- );
